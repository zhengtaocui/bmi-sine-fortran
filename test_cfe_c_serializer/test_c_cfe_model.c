 ...
 * Last date of modification: Mar 11, 2022
 * Description: Copied from the CFE serilization test code at 
 *      https://github.com/NOAA-OWP/cfe.git/test_serialize/cfe_serialize_test.c
 *      with minor revisions, such as changing the function signature.
 *
 */
...
//------------------------------------------------------------------------
// int test_c_cfe_model()
int test_c_cfe_model()
{
  // Check for config file arg
  const char *cfg_file = "./cat_89_bmi_config_cfe.txt";
